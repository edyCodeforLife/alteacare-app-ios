...
class ClosePaymentConfirmationVC: UIViewController, ClosePaymentConfirmationView {
    ...
    func setupUI() {
        let info = "Anda dapat melanjutkan pembayaran di halaman <b>telekonsultasi Saya</b>."
        let confirmation = "Apakah Anda yakin ingin menutup halaman Pembayaran ini?"
        self.infoLabel.attributedText = info.boldPartOfText(size: 14)
...
extension ClosePaymentConfirmationVC : PanModalPresentable{
