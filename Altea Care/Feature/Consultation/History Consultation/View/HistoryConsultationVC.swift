...
class HistoryConsultationVC: UIViewController, IndicatorInfoProvider, HistoryConsultationView {
    
    var viewModel: HistoryConsultationVM!
    var onConsultationTapped: ((HistoryConsultationModel) -> Void)?
    ...
    private var model = [HistoryConsultationModel]() {
        didSet {
    ...
    func bindViewModel() {
        let input = HistoryConsultationVM.Input(viewDidLoadRelay: viewDidLoadRelay.asObservable(), filterDay: filterRelay.asObservable())
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Riwayat")
    }
...
extension HistoryConsultationVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if model.count == 0 {
            ...
            cell.setupEmptyCell(page: "history")
            ...
            cell.setupHistoryCosultation(model: target)
            return cell
        }
    }
...
extension HistoryConsultationVC: UITableViewDelegate {
...
extension HistoryConsultationVC: SortPickerDelegate {
...
extension HistoryConsultationVC: FilterMemberDelegate{
...
extension HistoryConsultationVC {
